...
public class CheckerBoard
{
	...
	public CheckerBoard(final int player)
	{
		int row = 0;
		for (int i = 0; i < 64; i++)
		{
			...
			if (i % 2 == 0)
			{
				...
				else
				{
					...
					panel.addMouseListener(new MouseListener()
					{
						...
						{if (player == 1) Piece.move1(me);
						 else if (player == 2) Piece.move2(me);}
	...
	public static void setToolBar(final int p)
	{
	...
	public static void setToolBar(final int p, String text)
	{
		JMenuBar toolbar = new JMenuBar();
		toolbar.setPreferredSize(new Dimension(550, 20));
		toolbar.setBackground(Checkers.getTertiary());
